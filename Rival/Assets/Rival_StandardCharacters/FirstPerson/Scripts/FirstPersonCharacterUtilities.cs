...
public static class FirstPersonCharacterUtilities
{
        ...
        float3 characterUp)
    {
        ...
        float3 newCharacterForward = math.normalizesafe(Rival.MathUtilities.ProjectOnPlane(targetLookDirection, characterUp));
        ...
        viewPitchDegrees = math.degrees(Rival.MathUtilities.AngleRadians(newCharacterForward, targetLookDirection));
