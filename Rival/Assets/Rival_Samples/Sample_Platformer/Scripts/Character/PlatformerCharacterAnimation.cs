...
namespace Rival.Samples.Platformer
{
    ...
    {
        [HideInInspector]
        public int ClipIndexParameterHash;
        ...
        [HideInInspector]
        public int InAirClip;
        [HideInInspector]
        public int LedgeGrabMoveClip;
        [HideInInspector]
        public int LedgeStandUpClip;
        [HideInInspector]
        public int WallRunLeftClip;
        [HideInInspector]
        public int WallRunRightClip;
        [HideInInspector]
        public int CrouchIdleClip;
        [HideInInspector]
        public int CrouchMoveClip;
        [HideInInspector]
        public int ClimbingMoveClip;
        [HideInInspector]
        public int SwimmingIdleClip;
        [HideInInspector]
        public int SwimmingMoveClip;
        [HideInInspector]
        public int DashClip;
        [HideInInspector]
        public int RopeHangClip;
        [HideInInspector]
        public int SlidingClip;

        [HideInInspector]
        public CharacterState LastAnimationCharacterState;
    }
    ...
    public static class PlatformerCharacterAnimationHandler
    {
            ...
            in Rotation rotation)
        {
            ...
            switch (characterStateMachine.CurrentCharacterState)
            {
                case CharacterState.GroundMove:
                    {
                        if (math.length(inputs.Move) < 0.01f)
                        {
                            animator.speed = 1f;
                ...
                case CharacterState.WallRun:
                    {
                        bool wallIsOnTheLeft = math.dot(MathUtilities.GetRightFromRotation(rotation.Value), characterComponent.LastKnownWallNormal) > 0f;
                        animator.speed = 1f;
                ...
                case CharacterState.Sliding:
                    {
                        animator.speed = 1f;
                        animator.SetInteger(characterAnimation.ClipIndexParameterHash, characterAnimation.SlidingClip);
                    }
                    break;
            ...
            characterAnimation.LastAnimationCharacterState = characterStateMachine.CurrentCharacterState;
        }
    }
}