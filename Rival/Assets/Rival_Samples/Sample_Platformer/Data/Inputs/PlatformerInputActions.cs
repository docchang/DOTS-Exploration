...
//     version 1.4.3
//     from Assets/Rival_Samples/Sample_Platformer/Data/Inputs/PlatformerInputActions.inputactions
//
        ...
        public struct GameplayMapActions
        {
            ...
            public void SetCallbacks(IGameplayMapActions instance)
            {
                if (m_Wrapper.m_GameplayMapActionsCallbackInterface != null)
                {
                    ...
                    @LookDelta.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookDelta;
                    @LookDelta.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookDelta;
                    @LookDelta.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookDelta;
                    @LookConst.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookConst;
                    @LookConst.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookConst;
                    @LookConst.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnLookConst;
                    ...
                    @Roll.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRoll;
                    @Roll.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRoll;
                    @Roll.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRoll;
                    @Sprint.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnSprint;
                    @Sprint.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnSprint;
                    @Sprint.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnSprint;
                    @CameraZoom.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCameraZoom;
                    @CameraZoom.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCameraZoom;
                    @CameraZoom.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCameraZoom;
                    @Dash.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnDash;
                    @Dash.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnDash;
                    @Dash.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnDash;
                    @Crouch.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCrouch;
                    @Crouch.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCrouch;
                    @Crouch.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnCrouch;
                    @Rope.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRope;
                    @Rope.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRope;
                    @Rope.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnRope;
                    @Climb.started -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnClimb;
                    @Climb.performed -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnClimb;
                    @Climb.canceled -= m_Wrapper.m_GameplayMapActionsCallbackInterface.OnClimb;
