...
//     version 1.4.3
//     from Assets/Rival_Samples/Sample_OnlineFPS/Data/Input/FPSInputActions.inputactions
//
        ...
        public struct DefaultMapActions
        {
            ...
            public void SetCallbacks(IDefaultMapActions instance)
            {
                if (m_Wrapper.m_DefaultMapActionsCallbackInterface != null)
                {
                    ...
                    @LookDelta.started -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookDelta;
                    @LookDelta.performed -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookDelta;
                    @LookDelta.canceled -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookDelta;
                    @LookConst.started -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookConst;
                    @LookConst.performed -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookConst;
                    @LookConst.canceled -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnLookConst;
                    @Scroll.started -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnScroll;
                    @Scroll.performed -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnScroll;
                    @Scroll.canceled -= m_Wrapper.m_DefaultMapActionsCallbackInterface.OnScroll;
